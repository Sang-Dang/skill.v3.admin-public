...
import { App, Avatar, Button, Card, Flex, Form, Input, Pagination, Tooltip, Typography } from 'antd'
...
export default function CreateVoucherForm({ step, setStep, nextStep, prevStep }: Props) {
