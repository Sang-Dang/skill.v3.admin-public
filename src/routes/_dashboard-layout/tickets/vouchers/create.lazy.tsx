...
export const Route = createLazyFileRoute('/_dashboard-layout/tickets/vouchers/create')({
    ...
    return (
        <section>
            <Card
                title={
                    <>
                        <span className='hidden xs:inline'>Select Project</span>
            ...
            >
                <Form.Item<Step1_FieldType> name='project' rules={[{ required: true, message: 'Please select a project' }]}>
                    <CheckCard.Group loading={projects.isLoading} className='w-full' bordered>
                        {projects.isSuccess && (
                            <>
                                <div className='grid gap-3 xs:grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3'>
    ...
    return (
        <section>
            <Card
                title={
                    <>
                        <span className='hidden xs:inline'>Select Ticket</span>
